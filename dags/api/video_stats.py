...
CHANNEL_HANDLE = Variable.getenv("CHANNEL_HANDLE")
...
def save_to_json(extracted_data):
    file_path = f"./section2 - Data Extraction with youtube API/data/YT_data_{date.today()}.json"
...
if __name__ == "__main__":
    ...
    save_to_json(extracted_data=video_data)

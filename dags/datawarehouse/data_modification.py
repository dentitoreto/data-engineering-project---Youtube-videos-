import logging
from .data_utils import table_name
    ...
    try:
        ...
        cur.execute(
            f"""
                ...
                SET "Video_Title" = %({video_title})s,"Video_Views" = %({video_views})s,"Likes_Count" = %({likes_count})s,"Comments_Count" = %({comments_count})s
...
def delete_rows(cur, conn, schema, ids_to_delete):
    try:
        ...
        logger.error(f"Error deleting rows: {ids_to_delete} - {e}")
        raise e
